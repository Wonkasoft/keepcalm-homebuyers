...
<section id="primary" class="container-fluid" style="background: url('<?php echo $main_image; ?>');">
...
<section class="container-fluid content-section">
		...
		<p class="featured-message">
			<span>keep calm home buyers</span>can purchase your home fast to help in situations such 
