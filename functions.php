...
if ( ! function_exists( 'keepcalm_homebuyers_setup' ) ) :
	...
	function keepcalm_homebuyers_setup() {
		...
		register_nav_menus( array(
			...
			'social-media-menu' => esc_html__( 'Social_Media_Menu', 'keepcalm-homebuyers' ),
...
function keepcalm_homebuyers_scripts() {
	...
	wp_enqueue_script( 'keepcalm-homebuyers-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
